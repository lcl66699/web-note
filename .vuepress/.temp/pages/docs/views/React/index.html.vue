...
创建项目,脚手架：下载别人写好的配置
<code v-pre>npm i -g yarn</code>先安这个 再安下面的更快</li>
</ul>
<p><code v-pre>npx create-react-app my-app</code></p>
<p>安装时还可以先把脚手架下载好，再通过脚手架下载项目</p>
<p><code v-pre>npm i -g create - react -app</code>
<code v-pre>create -react- app my- appcreate -react- app my- app</code></p>
...
<p>JSX属性：写在标签的属性上</p>
<ul>
<li>改名<code v-pre>&lt;div className=''&gt;&lt;/div&gt;</code>  <code v-pre>&lt;label htmlfor=''&gt;&lt;/label&gt;</code></li>
<li>标签上添加行内样式时，需要使用对象形式</li>
<li><code v-pre>&lt;div id={uid}  style={color:'red',fontSize:'14px'}&gt;&lt;/div&gt;</code></li>
</ul>
</li>
<li>
...
react元素写法:
<ul>
<li>直接使用jsx语法: <code v-pre>&lt;div&gt;{uname}&lt;/div&gt;</code></li>
<li>使用 <code v-pre>React. createElement()</code></li>
</ul>
</li>
<li>使用组件<code v-pre>&lt;App /&gt;</code>
<code v-pre>ReactDOM.render(&lt;Home/&gt;,document.getElementById('root'))</code></li>
</ol>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>函数组件不用hook语法时，功能弱j，有hook语法后 替代类形式组件。</p>
<ul>
<li>类形式组件 rcc</li>
</ul>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>前期使用类组件，会学习类组件中的state,生命周期函数。不管什么组件 必须引入react7</p>
...
<p><code v-pre>export {Home}</code>
<code v-pre>export default Home</code></p>
<h4 id="导入组件" tabindex="-1"><a class="header-anchor" href="#导入组件" aria-hidden="true">#</a> 导入组件</h4>
<p><code v-pre>import {Home} from 'path'</code>
<code v-pre>import AppHome from 'path'</code></p>
<h4 id="使用组件-当成标签使用" tabindex="-1"><a class="header-anchor" href="#使用组件-当成标签使用" aria-hidden="true">#</a> 使用组件,当成标签使用</h4>
<p><code v-pre>&lt;Home /&gt;</code>
<code v-pre>&lt;Home&gt;&lt;/Home&gt;</code></p>
...
<code v-pre>&lt;Item data='string' arr={[1,2,3,4]}  /&gt;</code>
<code v-pre>&lt;Item picurl={arr[0].picurl} title={arr[0].title} /&gt;</code></li>
</ul>
...
<code v-pre>arr/obj.map(function(item,index){     return item })</code></p>
...
<li>使用state数据
<code v-pre>this.state.xx</code></li>
...
<p><code v-pre>this.setState({count:this.state.count+1})</code></p>
<ul>
<li>this.setState()方法 可能是异步的</li>
</ul>
<p><code v-pre>this.setState({},()=&gt;{})</code></p>
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">this</span><span class="token punctuation">.</span><span class="token function">setState</span><span class="token punctuation">(</span><span class="token punctuation">(</span>state<span class="token punctuation">)</span><span class="token operator">=</span><span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>函数中有一个参数state,这个state是谁?</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>如果视图内的数据需要修改, 并且同时页面响应变化，我们需要将数据放在state中, 使用setState来修改数据。</p>
...
<li>语法:
<code v-pre>&lt;div on+事件名={EventFunction}&gt;&lt;/div&gt;</code>
说明：</li>
</ul>
<ol>
<li>js的事件，驼峰命名法</li>
...
</span></code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="this指向问题" tabindex="-1"><a class="header-anchor" href="#this指向问题" aria-hidden="true">#</a> this指向问题</h3>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>如果当函数调用时没有传参，建议使用方法3(constructor中绑定)
...
<p><code v-pre>event.pagex / event . pageY</code>获取事件触发者</p>
<p><code v-pre>e.preventDefault()</code>阻止冒泡</p>
<p><code v-pre>e.stopPropagation()</code> 阻止默认事件</p>
<h3 id="表单" tabindex="-1"><a class="header-anchor" href="#表单" aria-hidden="true">#</a> 表单</h3>
<ul>
<li>form标签
<code v-pre>&lt;form action= 'http://xx/xx.php/xx. jsp/xx.asp' method= 'get post' &gt;&lt;/ form&gt;</code></li>
...
<p><code v-pre>&lt;input value={this.state.user} onChange={(e)=&gt;this.setState({user:e.currentTarget.vale})} /&gt;</code>
特殊的受控组件：单选按钮,多选按钮</p>
<ul>
<li>value属性值不能改变</li>
...
<li>用法
<ol>
<li>让父级向子级传递一个函数 <code v-pre>&lt;Son user= getSonDate={this.getSonDate.bind(this)}/&gt;</code></li>
<li>在子级组件中调用传递来的这个方法 <code v-pre>this.props.getSonDate(this.state.user)</code></li>
<li>在子级组件中调用这个函数时可以传递实参 <code v-pre>this.setState({list:cs})</code></li>
<li>在父级函数中接收数据</li>
</ol>
</li>
</ol>
...
<li>使用步骤</li>
<li>引入验证包 <code v-pre>import PropTypes from 'prop-types' ;</code></li>
</ol>
</li>
<li>定义需要验证的prop属性
类组件中用法：</li>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="配置less" tabindex="-1"><a class="header-anchor" href="#配置less" aria-hidden="true">#</a> 配置less</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="refs-转发" tabindex="-1"><a class="header-anchor" href="#refs-转发" aria-hidden="true">#</a> Refs 转发</h2>
<ol>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>在父类可以通过事件输出 console.log(this.ref1.current);</p>
<p>然后在组件中传过去ref <code v-pre>&lt;Sonref ref={this.ref1} msg='2006'/&gt; </code>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="fragments" tabindex="-1"><a class="header-anchor" href="#fragments" aria-hidden="true">#</a> Fragments</h3>
<ol>
<li>Fragments 允许你将子列表分组，而无需向 DOM 添加额外节点。</li>
<li>语法：
<code v-pre>&lt;React.Fragment&gt;&lt;/React.Fragment&gt;</code>
简写语法： &lt;&gt;...&lt;/&gt;</li>
</ol>
...
<span class="token template-string"><span class="token template-punctuation string">`</span><span class="token string"> &lt;Son ref={myref} /></span><span class="token template-punctuation string">`</span></span>
  ...
  <span class="token punctuation">}</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="自定义hook" tabindex="-1"><a class="header-anchor" href="#自定义hook" aria-hidden="true">#</a> 自定义hook</h3>
