<template><div><h1 id="计算机网络篇" tabindex="-1"><a class="header-anchor" href="#计算机网络篇" aria-hidden="true">#</a> 计算机网络篇</h1>
<h2 id="一、http协议" tabindex="-1"><a class="header-anchor" href="#一、http协议" aria-hidden="true">#</a> 一、HTTP协议</h2>
<h3 id="_1-get和post的请求的区别" tabindex="-1"><a class="header-anchor" href="#_1-get和post的请求的区别" aria-hidden="true">#</a> 1. GET和POST的请求的区别</h3>
...
<h3 id="_2-post和put请求的区别" tabindex="-1"><a class="header-anchor" href="#_2-post和put请求的区别" aria-hidden="true">#</a> 2. POST和PUT请求的区别</h3>
<ul>
...
<h3 id="_3-常见的http请求头和响应头" tabindex="-1"><a class="header-anchor" href="#_3-常见的http请求头和响应头" aria-hidden="true">#</a> 3. 常见的HTTP请求头和响应头</h3>
...
<h3 id="_4-http状态码304是多好还是少好" tabindex="-1"><a class="header-anchor" href="#_4-http状态码304是多好还是少好" aria-hidden="true">#</a> 4. HTTP状态码304是多好还是少好</h3>
...
<h3 id="_5-常见的http请求方法" tabindex="-1"><a class="header-anchor" href="#_5-常见的http请求方法" aria-hidden="true">#</a> 5. 常见的HTTP请求方法</h3>
<ul>
<li>GET: 向服务器获取数据；</li>
...
<h3 id="_6-options请求方法及使用场景" tabindex="-1"><a class="header-anchor" href="#_6-options请求方法及使用场景" aria-hidden="true">#</a> 6. OPTIONS请求方法及使用场景</h3>
<p>OPTIONS是除了GET和POST之外的其中一种 HTTP请求方法。</p>
<p>OPTIONS方法是用于请求获得由<code v-pre>Request-URI</code>标识的资源在请求/响应的通信过程中可以使用的功能选项。通过这个方法，客户端可以<strong>在采取具体资源请求之前，决定对该资源采取何种必要措施，或者了解服务器的性能</strong>。该请求方法的响应不能缓存。</p>
...
<h3 id="_7-http-1-0-和-http-1-1-之间有哪些区别" tabindex="-1"><a class="header-anchor" href="#_7-http-1-0-和-http-1-1-之间有哪些区别" aria-hidden="true">#</a> 7. HTTP 1.0 和 HTTP 1.1 之间有哪些区别？</h3>
...
<h3 id="_8-http-1-1-和-http-2-0-的区别" tabindex="-1"><a class="header-anchor" href="#_8-http-1-1-和-http-2-0-的区别" aria-hidden="true">#</a> 8. HTTP 1.1 和 HTTP 2.0 的区别</h3>
<ul>
...
<h3 id="_9-http和https协议的区别" tabindex="-1"><a class="header-anchor" href="#_9-http和https协议的区别" aria-hidden="true">#</a> 9. HTTP和HTTPS协议的区别</h3>
...
<h3 id="_10-get方法url长度限制的原因" tabindex="-1"><a class="header-anchor" href="#_10-get方法url长度限制的原因" aria-hidden="true">#</a> 10. GET方法URL长度限制的原因</h3>
<p>实际上HTTP协议规范并没有对get方法请求的url长度进行限制，这个限制是特定的浏览器及服务器对它的限制。 IE对URL长度的限制是2083字节(2K+35)。由于IE浏览器对URL长度的允许值是最小的，所以开发过程中，只要URL不超过2083字节，那么在所有浏览器中工作都不会有问题。</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token constant">GET</span>的长度值 <span class="token operator">=</span> <span class="token constant">URL</span>（<span class="token number">2083</span>）<span class="token operator">-</span> （你的Domain<span class="token operator">+</span>Path）<span class="token operator">-</span><span class="token number">2</span>（<span class="token number">2</span>是<span class="token keyword">get</span>请求中<span class="token operator">?</span><span class="token operator">=</span>两个字符的长度）

</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>下面看一下主流浏览器对get方法中url的长度限制范围：</p>
<ul>
...
<h3 id="_11-当在浏览器中输入-google-com-并且按下回车之后发生了什么" tabindex="-1"><a class="header-anchor" href="#_11-当在浏览器中输入-google-com-并且按下回车之后发生了什么" aria-hidden="true">#</a> 11. 当在浏览器中输入 Google.com 并且按下回车之后发生了什么？</h3>
...
<h3 id="_12-对keep-alive的理解" tabindex="-1"><a class="header-anchor" href="#_12-对keep-alive的理解" aria-hidden="true">#</a> 12. 对keep-alive的理解</h3>
...
<ul>
<li>HTTP1.0版本是默认没有Keep-alive的（也就是默认会发送keep-alive），所以要想连接得到保持，必须手动配置发送<code v-pre>Connection: keep-alive</code>字段。若想断开keep-alive连接，需发送<code v-pre>Connection:close</code>字段；</li>
<li>HTTP1.1规定了默认保持长连接，数据传输完成了保持TCP连接不断开，等待在同域名下继续用这个通道传输数据。如果需要关闭，需要客户端发送<code v-pre>Connection：close</code>首部字段。</li>
</ul>
...
<h3 id="_13-页面有多张图片-http是怎样的加载表现" tabindex="-1"><a class="header-anchor" href="#_13-页面有多张图片-http是怎样的加载表现" aria-hidden="true">#</a> 13. 页面有多张图片，HTTP是怎样的加载表现？</h3>
<ul>
<li>在<code v-pre>HTTP 1</code>下，浏览器对一个域名下最大TCP连接数为6，所以会请求多次。可以用<strong>多域名部署</strong>解决。这样可以提高同时请求的数目，加快页面图片的获取速度。</li>
<li>在<code v-pre>HTTP 2</code>下，可以一瞬间加载出来很多资源，因为，HTTP2支持多路复用，可以在一个TCP连接中发送多个HTTP请求。</li>
</ul>
<h3 id="_14-http2的头部压缩算法是怎样的" tabindex="-1"><a class="header-anchor" href="#_14-http2的头部压缩算法是怎样的" aria-hidden="true">#</a> 14. HTTP2的头部压缩算法是怎样的？</h3>
...
<p>例如下图中的两个请求， 请求一发送了所有的头部字段，第二个请求则只需要发送差异数据，这样可以减少冗余数据，降低开销。 <img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/bda10d6c69e74996b6505777d29b9a74~tplv-k3u1fbpfcp-watermark.awebp" alt="img"></p>
<h3 id="_15-http请求报文的是什么样的" tabindex="-1"><a class="header-anchor" href="#_15-http请求报文的是什么样的" aria-hidden="true">#</a> 15. HTTP请求报文的是什么样的？</h3>
<p>请求报⽂有4部分组成:</p>
<ul>
<li>请求⾏</li>
<li>请求头部</li>
...
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/4fb5bb2cb1664850b52e32d57af74f2f~tplv-k3u1fbpfcp-watermark.awebp" alt="image.png"> <strong>其中：</strong> （1）请求⾏包括：请求⽅法字段、URL字段、HTTP协议版本字段。它们⽤空格分隔。例如，GET /index.html HTTP/1.1。 （2）请求头部:请求头部由关键字/值对组成，每⾏⼀对，关键字和值⽤英⽂冒号“:”分隔</p>
<ul>
<li>User-Agent：产⽣请求的浏览器类型。</li>
<li>Accept：客户端可识别的内容类型列表。</li>
<li>Host：请求的主机名，允许多个域名同处⼀个IP地址，即虚拟主机。</li>
</ul>
<p>（3）请求体: post put等请求携带的数据 <img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/eacc55d7152149e99730346f1edfc9ab~tplv-k3u1fbpfcp-watermark.awebp" alt="image.png"></p>
<h3 id="_16-http响应报文的是什么样的" tabindex="-1"><a class="header-anchor" href="#_16-http响应报文的是什么样的" aria-hidden="true">#</a> 16. HTTP响应报文的是什么样的？</h3>
<p>请求报⽂有4部分组成:</p>
<ul>
<li>响应⾏</li>
<li>响应头</li>
...
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/1b0183eb91ce451aa17bd515d047062d~tplv-k3u1fbpfcp-watermark.awebp" alt="image.png"></p>
<ul>
<li>响应⾏：由网络协议版本，状态码和状态码的原因短语组成，例如 HTTP/1.1 200 OK 。</li>
<li>响应头：响应部⾸组成</li>
<li>响应体：服务器响应的数据</li>
</ul>
<h3 id="_17-http协议的优点和缺点" tabindex="-1"><a class="header-anchor" href="#_17-http协议的优点和缺点" aria-hidden="true">#</a> 17. HTTP协议的优点和缺点</h3>
...
<h3 id="_18-说一下http-3-0" tabindex="-1"><a class="header-anchor" href="#_18-说一下http-3-0" aria-hidden="true">#</a> 18. 说一下HTTP 3.0</h3>
<p>HTTP/3基于UDP协议实现了类似于TCP的多路复用数据流、传输可靠性等功能，这套功能被称为QUIC协议。 <img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/45a0a2ec0ef143b49d79256cea543418~tplv-k3u1fbpfcp-watermark.awebp" alt="img"></p>
<ol>
...
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/48df233ce8e541efa165160c169b7a70~tplv-k3u1fbpfcp-watermark.awebp" alt="img"></p>
<ol>
<li>快速握手：由于基于UDP，可以实现使用0 ~ 1个RTT来建立连接。</li>
</ol>
<h3 id="_19-http协议的性能怎么样" tabindex="-1"><a class="header-anchor" href="#_19-http协议的性能怎么样" aria-hidden="true">#</a> 19. HTTP协议的性能怎么样</h3>
...
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/f756e23ecf3a4d2a80d632b5fa8b0b6d~tplv-k3u1fbpfcp-watermark.awebp" alt="img"></p>
<ul>
...
<h3 id="_20-url有哪些组成部分" tabindex="-1"><a class="header-anchor" href="#_20-url有哪些组成部分" aria-hidden="true">#</a> 20. URL有哪些组成部分</h3>
<p>以下面的URL为例：<strong><a href="https://link.juejin.cn?target=http%3A%2F%2Fwww.aspxfans.com%3A8080%2Fnews%2Findex.asp%3FboardID%3D5%26ID%3D24618%26page%3D1%23name" target="_blank" rel="noopener noreferrer">www.aspxfans.com:8080/news/index.…<ExternalLinkIcon/></a></strong></p>
...
<li><strong>域名部分</strong>：该URL的域名部分为“<a href="https://link.juejin.cn?target=http%3A%2F%2Fwww.aspxfans.com%E2%80%9D%E3%80%82%E4%B8%80%E4%B8%AAURL%E4%B8%AD%EF%BC%8C%E4%B9%9F%E5%8F%AF%E4%BB%A5%E4%BD%BF%E7%94%A8IP%E5%9C%B0%E5%9D%80%E4%BD%9C%E4%B8%BA%E5%9F%9F%E5%90%8D%E4%BD%BF%E7%94%A8" target="_blank" rel="noopener noreferrer">www.aspxfans.com”。一个URL中，也可以使用IP地址作为域名使用<ExternalLinkIcon/></a></li>
...
<h3 id="_21-与缓存相关的http请求头有哪些" tabindex="-1"><a class="header-anchor" href="#_21-与缓存相关的http请求头有哪些" aria-hidden="true">#</a> 21. 与缓存相关的HTTP请求头有哪些</h3>
<p>强缓存：</p>
<ul>
<li>Expires</li>
<li>Cache-Control</li>
...
<h2 id="二、https协议" tabindex="-1"><a class="header-anchor" href="#二、https协议" aria-hidden="true">#</a> 二、HTTPS协议</h2>
<h3 id="_1-什么是https协议" tabindex="-1"><a class="header-anchor" href="#_1-什么是https协议" aria-hidden="true">#</a> 1. 什么是HTTPS协议？</h3>
<p>超文本传输安全协议（Hypertext Transfer Protocol Secure，简称：HTTPS）是一种通过计算机网络进行安全通信的传输协议。HTTPS经由HTTP进行通信，利用SSL/TLS来加密数据包。HTTPS的主要目的是提供对网站服务器的身份认证，保护交换数据的隐私与完整性。 <img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/10885a9d4d574d7caf3fee1416f623ca~tplv-k3u1fbpfcp-watermark.awebp" alt="img"> HTTP协议采用<strong>明文传输</strong>信息，存在<strong>信息窃听</strong>、<strong>信息篡改</strong>和<strong>信息劫持</strong>的风险，而协议TLS/SSL具有<strong>身份验证</strong>、<strong>信息加密</strong>和<strong>完整性校验</strong>的功能，可以避免此类问题发生。</p>
<p>安全层的主要职责就是<strong>对发起的HTTP请求的数据进行加密操作</strong> 和 <strong>对接收到的HTTP的内容进行解密操作</strong>。</p>
<h3 id="_2-tls-ssl的工作原理" tabindex="-1"><a class="header-anchor" href="#_2-tls-ssl的工作原理" aria-hidden="true">#</a> 2. TLS/SSL的工作原理</h3>
...
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/5696ee8ccb0d44b08b812a7c964695b7~tplv-k3u1fbpfcp-watermark.awebp" alt="img"></p>
<h4 id="_1-散列函数hash" tabindex="-1"><a class="header-anchor" href="#_1-散列函数hash" aria-hidden="true">#</a> （1）散列函数hash</h4>
...
<h4 id="_2-对称加密" tabindex="-1"><a class="header-anchor" href="#_2-对称加密" aria-hidden="true">#</a> （2）对称加密</h4>
...
<h4 id="_3-非对称加密" tabindex="-1"><a class="header-anchor" href="#_3-非对称加密" aria-hidden="true">#</a> （3）非对称加密</h4>
...
<h3 id="_3-数字证书是什么" tabindex="-1"><a class="header-anchor" href="#_3-数字证书是什么" aria-hidden="true">#</a> 3. 数字证书是什么？</h3>
...
<p>这个方法最要的是认证中心的可靠性，一般浏览器里会内置一些顶层的认证中心的证书，相当于我们自动信任了他们，只有这样才能保证数据的安全。 <img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/90da1f506e7040aaba5e1536c1f6c373~tplv-k3u1fbpfcp-watermark.awebp" alt="img"></p>
<h3 id="_4-https通信-握手-过程" tabindex="-1"><a class="header-anchor" href="#_4-https通信-握手-过程" aria-hidden="true">#</a> 4. HTTPS通信（握手）过程</h3>
<p>HTTPS的通信过程如下：</p>
<ol>
...
<h3 id="_5-https的特点" tabindex="-1"><a class="header-anchor" href="#_5-https的特点" aria-hidden="true">#</a> 5. HTTPS的特点</h3>
...
<h3 id="_6-https是如何保证安全的" tabindex="-1"><a class="header-anchor" href="#_6-https是如何保证安全的" aria-hidden="true">#</a> 6. <strong>HTTPS</strong>是如何保证安全的？</h3>
<p>先理解两个概念：</p>
<ul>
...
<h2 id="三、http状态码" tabindex="-1"><a class="header-anchor" href="#三、http状态码" aria-hidden="true">#</a> 三、HTTP状态码</h2>
<p>状态码的类别：</p>
<table>
<thead>
<tr>
...
<h3 id="_1-2xx-success-成功状态码" tabindex="-1"><a class="header-anchor" href="#_1-2xx-success-成功状态码" aria-hidden="true">#</a> 1. 2XX (Success 成功状态码)</h3>
<p>状态码2XX表示请求被正常处理了。</p>
<h4 id="_1-200-ok" tabindex="-1"><a class="header-anchor" href="#_1-200-ok" aria-hidden="true">#</a> （1）200 OK</h4>
<p>200 OK表示客户端发来的请求被服务器端正常处理了。</p>
<h4 id="_2-204-no-content" tabindex="-1"><a class="header-anchor" href="#_2-204-no-content" aria-hidden="true">#</a> （2）204 No Content</h4>
<p>该状态码表示客户端发送的请求已经在服务器端正常处理了，但是没有返回的内容，响应报文中不包含实体的主体部分。一般在只需要从客户端往服务器端发送信息，而服务器端不需要往客户端发送内容时使用。</p>
<h4 id="_3-206-partial-content" tabindex="-1"><a class="header-anchor" href="#_3-206-partial-content" aria-hidden="true">#</a> （3）206 Partial Content</h4>
<p>该状态码表示客户端进行了范围请求，而服务器端执行了这部分的 GET 请求。响应报文中包含由 Content-Range 指定范围的实体内容。</p>
<h3 id="_2-3xx-redirection-重定向状态码" tabindex="-1"><a class="header-anchor" href="#_2-3xx-redirection-重定向状态码" aria-hidden="true">#</a> 2. 3XX (Redirection 重定向状态码)</h3>
<p>3XX 响应结果表明浏览器需要执行某些特殊的处理以正确处理请求。</p>
<h4 id="_1-301-moved-permanently" tabindex="-1"><a class="header-anchor" href="#_1-301-moved-permanently" aria-hidden="true">#</a> （1）301 Moved Permanently</h4>
...
<h4 id="_2-302-found" tabindex="-1"><a class="header-anchor" href="#_2-302-found" aria-hidden="true">#</a> （2）302 Found</h4>
...
<h4 id="_3-303-see-other" tabindex="-1"><a class="header-anchor" href="#_3-303-see-other" aria-hidden="true">#</a> （3）303 See Other</h4>
<p>该状态码表示由于请求对应的资源存在着另一个 URI，应使用 GET 方法定向获取请求的资源。 303 状态码和 302 Found 状态码有着相似的功能，但是 303 状态码明确表示客户端应当采用 GET 方法获取资源。</p>
...
<h4 id="_4-304-not-modified" tabindex="-1"><a class="header-anchor" href="#_4-304-not-modified" aria-hidden="true">#</a> （4）304 Not Modified</h4>
...
<p>带条件的请求（Http 条件请求）：使用 Get方法 请求，请求报文中包含（<code v-pre>if-match</code>、<code v-pre>if-none-match</code>、<code v-pre>if-modified-since</code>、<code v-pre>if-unmodified-since</code>、<code v-pre>if-range</code>）中任意首部。</p>
<p>状态码304并不是一种错误，而是告诉客户端有缓存，直接使用缓存中的数据。返回页面的只有头部信息，是没有内容部分的，这样在一定程度上提高了网页的性能。</p>
<h4 id="_5-307-temporary-redirect" tabindex="-1"><a class="header-anchor" href="#_5-307-temporary-redirect" aria-hidden="true">#</a> （5）307 Temporary Redirect</h4>
...
<h3 id="_3-4xx-client-error-客户端错误状态码" tabindex="-1"><a class="header-anchor" href="#_3-4xx-client-error-客户端错误状态码" aria-hidden="true">#</a> 3. 4XX (Client Error 客户端错误状态码)</h3>
<p>4XX 的响应结果表明客户端是发生错误的原因所在。</p>
<h4 id="_1-400-bad-request" tabindex="-1"><a class="header-anchor" href="#_1-400-bad-request" aria-hidden="true">#</a> （1）400 Bad Request</h4>
<p>该状态码表示请求报文中存在语法错误。当错误发生时，需修改请求的内容后再次发送请求。另外，浏览器会像 200 OK 一样对待该状态码。</p>
<h4 id="_2-401-unauthorized" tabindex="-1"><a class="header-anchor" href="#_2-401-unauthorized" aria-hidden="true">#</a> （2）401 Unauthorized</h4>
...
<h4 id="_3-403-forbidden" tabindex="-1"><a class="header-anchor" href="#_3-403-forbidden" aria-hidden="true">#</a> （3）403 Forbidden</h4>
...
<h4 id="_4-404-not-found" tabindex="-1"><a class="header-anchor" href="#_4-404-not-found" aria-hidden="true">#</a> （4）404 Not Found</h4>
<p>该状态码表明服务器上无法找到请求的资源。除此之外，也可以在服务器端拒绝请求且不想说明理由时使用。 以下情况会出现404：</p>
<ul>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_4-5xx-server-error-服务器错误状态码" tabindex="-1"><a class="header-anchor" href="#_4-5xx-server-error-服务器错误状态码" aria-hidden="true">#</a> 4. 5XX (Server Error 服务器错误状态码)</h3>
<p>5XX 的响应结果表明服务器本身发生错误.</p>
<h4 id="_1-500-internal-server-error" tabindex="-1"><a class="header-anchor" href="#_1-500-internal-server-error" aria-hidden="true">#</a> （1）500 Internal Server Error</h4>
<p>该状态码表明服务器端在执行请求时发生了错误。也有可能是 Web 应用存在的 bug 或某些临时的故障。</p>
<h4 id="_2-502-bad-gateway" tabindex="-1"><a class="header-anchor" href="#_2-502-bad-gateway" aria-hidden="true">#</a> （2）502 Bad Gateway</h4>
...
<h4 id="_3-503-service-unavailable" tabindex="-1"><a class="header-anchor" href="#_3-503-service-unavailable" aria-hidden="true">#</a> （3）503 Service Unavailable</h4>
...
<h4 id="_4-504-gateway-timeout" tabindex="-1"><a class="header-anchor" href="#_4-504-gateway-timeout" aria-hidden="true">#</a> （4）504 Gateway Timeout</h4>
...
<h3 id="_6-同样是重定向-307-303-302的区别" tabindex="-1"><a class="header-anchor" href="#_6-同样是重定向-307-303-302的区别" aria-hidden="true">#</a> 6. 同样是重定向，<strong>307</strong>，<strong>303</strong>，<strong>302</strong>的区别？</h3>
...
<h2 id="四、dns协议介绍" tabindex="-1"><a class="header-anchor" href="#四、dns协议介绍" aria-hidden="true">#</a> 四、DNS协议介绍</h2>
<h3 id="_1-dns-协议是什么" tabindex="-1"><a class="header-anchor" href="#_1-dns-协议是什么" aria-hidden="true">#</a> 1. DNS 协议是什么</h3>
...
<h3 id="_2-dns同时使用tcp和udp协议" tabindex="-1"><a class="header-anchor" href="#_2-dns同时使用tcp和udp协议" aria-hidden="true">#</a> 2. DNS同时使用TCP和UDP协议？</h3>
<p><strong>DNS占用53号端口，同时使用TCP和UDP协议。</strong> （1）在区域传输的时候使用TCP协议</p>
<ul>
...
<h3 id="_3-dns完整的查询过程" tabindex="-1"><a class="header-anchor" href="#_3-dns完整的查询过程" aria-hidden="true">#</a> 3. DNS完整的查询过程</h3>
<p>DNS服务器解析域名的过程：</p>
<ul>
...
<p>比如要查询 <a href="https://link.juejin.cn?target=http%3A%2F%2Fwww.baidu.com%2F" target="_blank" rel="noopener noreferrer">www.baidu.com<ExternalLinkIcon/></a> 的 IP 地址，首先会在浏览器的缓存中查找是否有该域名的缓存，如果不存在就将请求发送到本地的 DNS 服务器中，本地DNS服务器会判断是否存在该域名的缓存，如果不存在，则向根域名服务器发送一个请求，根域名服务器返回负责 .com 的顶级域名服务器的 IP 地址的列表。然后本地 DNS 服务器再向其中一个负责 .com 的顶级域名服务器发送一个请求，负责 .com 的顶级域名服务器返回负责 .baidu 的权威域名服务器的 IP 地址列表。然后本地 DNS 服务器再向其中一个权威域名服务器发送一个请求，最后权威域名服务器返回一个对应的主机名的 IP 地址列表。</p>
<h3 id="_4-迭代查询与递归查询" tabindex="-1"><a class="header-anchor" href="#_4-迭代查询与递归查询" aria-hidden="true">#</a> 4. 迭代查询与递归查询</h3>
...
<h3 id="_5-dns-记录和报文" tabindex="-1"><a class="header-anchor" href="#_5-dns-记录和报文" aria-hidden="true">#</a> 5. DNS 记录和报文</h3>
<p>DNS 服务器中以资源记录的形式存储信息，每一个 DNS 响应报文一般包含多条资源记录。一条资源记录的具体的格式为</p>
<div class="language-http ext-http line-numbers-mode"><pre v-pre class="language-http"><code>（Name，Value，Type，TTL）

</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>其中 TTL 是资源记录的生存时间，它定义了资源记录能够被其他的 DNS 服务器缓存多长时间。</p>
...
<h2 id="五、网络模型" tabindex="-1"><a class="header-anchor" href="#五、网络模型" aria-hidden="true">#</a> 五、网络模型</h2>
<h3 id="_1-osi七层模型" tabindex="-1"><a class="header-anchor" href="#_1-osi七层模型" aria-hidden="true">#</a> 1. OSI七层模型</h3>
<p><code v-pre>ISO</code>为了更好的使网络应用更为普及，推出了<code v-pre>OSI</code>参考模型。 <img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/c1e8e168d9f249788c74c5b50e0528e2~tplv-k3u1fbpfcp-watermark.awebp" alt="img"></p>
<h4 id="_1-应用层" tabindex="-1"><a class="header-anchor" href="#_1-应用层" aria-hidden="true">#</a> （1）应用层</h4>
<p><code v-pre>OSI</code>参考模型中最靠近用户的一层，是为计算机用户提供应用接口，也为用户直接提供各种网络服务。我们常见应用层的网络服务协议有：<code v-pre>HTTP</code>，<code v-pre>HTTPS</code>，<code v-pre>FTP</code>，<code v-pre>POP3</code>、<code v-pre>SMTP</code>等。</p>
<ul>
<li>在客户端与服务器中经常会有数据的请求，这个时候就是会用到<code v-pre>http(hyper text transfer protocol)(超文本传输协议)</code>或者<code v-pre>https</code>.在后端设计数据接口时，我们常常使用到这个协议。</li>
<li><code v-pre>FTP</code>是文件传输协议，在开发过程中，个人并没有涉及到，但是我想，在一些资源网站，比如<code v-pre>百度网盘``迅雷</code>应该是基于此协议的。</li>
<li><code v-pre>SMTP</code>是<code v-pre>simple mail transfer protocol（简单邮件传输协议）</code>。在一个项目中，在用户邮箱验证码登录的功能时，使用到了这个协议。</li>
</ul>
<h4 id="_2-表示层" tabindex="-1"><a class="header-anchor" href="#_2-表示层" aria-hidden="true">#</a> （2）表示层</h4>
...
<p>在项目开发中，为了方便数据传输，可以使用<code v-pre>base64</code>对数据进行编解码。如果按功能来划分，<code v-pre>base64</code>应该是工作在表示层。</p>
<h4 id="_3-会话层" tabindex="-1"><a class="header-anchor" href="#_3-会话层" aria-hidden="true">#</a> （3）会话层</h4>
<p>会话层就是负责建立、管理和终止表示层实体之间的通信会话。该层的通信由不同设备中的应用程序之间的服务请求和响应组成。</p>
<h4 id="_4-传输层" tabindex="-1"><a class="header-anchor" href="#_4-传输层" aria-hidden="true">#</a> （4）传输层</h4>
<p>传输层建立了主机端到端的链接，传输层的作用是为上层协议提供端到端的可靠和透明的数据传输服务，包括处理差错控制和流量控制等问题。该层向高层屏蔽了下层数据通信的细节，使高层用户看到的只是在两个传输实体间的一条主机到主机的、可由用户控制和设定的、可靠的数据通路。我们通常说的，<code v-pre>TCP</code> <code v-pre>UDP</code>就是在这一层。端口号既是这里的“端”。</p>
<h4 id="_5-网络层" tabindex="-1"><a class="header-anchor" href="#_5-网络层" aria-hidden="true">#</a> （5）网络层</h4>
<p>本层通过<code v-pre>IP</code>寻址来建立两个节点之间的连接，为源端的运输层送来的分组，选择合适的路由和交换节点，正确无误地按照地址传送给目的端的运输层。就是通常说的<code v-pre>IP</code>层。这一层就是我们经常说的<code v-pre>IP</code>协议层。<code v-pre>IP</code>协议是<code v-pre>Internet</code>的基础。我们可以这样理解，网络层规定了数据包的传输路线，而传输层则规定了数据包的传输方式。</p>
<h4 id="_6-数据链路层" tabindex="-1"><a class="header-anchor" href="#_6-数据链路层" aria-hidden="true">#</a> （6）数据链路层</h4>
<p>将比特组合成字节,再将字节组合成帧,使用链路层地址 (以太网使用MAC地址)来访问介质,并进行差错检测。 网络层与数据链路层的对比，通过上面的描述，我们或许可以这样理解，网络层是规划了数据包的传输路线，而数据链路层就是传输路线。不过，在数据链路层上还增加了差错控制的功能。</p>
<h4 id="_7-物理层" tabindex="-1"><a class="header-anchor" href="#_7-物理层" aria-hidden="true">#</a> （7）物理层</h4>
...
<h3 id="_2-tcp-ip五层协议" tabindex="-1"><a class="header-anchor" href="#_2-tcp-ip五层协议" aria-hidden="true">#</a> 2. TCP/IP五层协议</h3>
<p><code v-pre>TCP/IP</code>五层协议和<code v-pre>OSI</code>的七层协议对应关系如下： <img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/48cd77d608714c298366f4dac77f33fb~tplv-k3u1fbpfcp-watermark.awebp" alt="img"></p>
<ul>
<li>
<p><strong>应用层 (application layer)</strong>：直接为应用进程提供服务。应用层协议定义的是应用进程间通讯和交互的规则，不同的应用有着不同的应用层协议，如 HTTP协议（万维网服务）、FTP协议（文件传输）、SMTP协议（电子邮件）、DNS（域名查询）等。</p>
</li>
<li>
...
<li>
<p><strong>网络层 (internet layer)</strong>：有时也译为网际层，它负责为两台主机提供通信服务，并通过选择合适的路由将数据传递到目标主机。</p>
</li>
<li>
<p><strong>数据链路层 (data link layer)</strong>：负责将网络层交下来的 IP 数据报封装成帧，并在链路的两个相邻节点间传送帧，每一帧都包含数据和必要的控制信息（如同步信息、地址信息、差错控制等）。</p>
</li>
<li>
<p><strong>物理层 (physical Layer)</strong>：确保数据可以在各种物理媒介上进行传输，为数据的传输提供可靠的环境。</p>
</li>
</ul>
<p>从上图中可以看出，<code v-pre>TCP/IP</code>模型比<code v-pre>OSI</code>模型更加简洁，它把<code v-pre>应用层/表示层/会话层</code>全部整合为了<code v-pre>应用层</code>。</p>
<p>在每一层都工作着不同的设备，比如我们常用的交换机就工作在数据链路层的，一般的路由器是工作在网络层的。 <img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/8a89b9ddb9d541a880fee0dccd1c03e9~tplv-k3u1fbpfcp-watermark.awebp" alt="img"> 在每一层实现的协议也各不同，即每一层的服务也不同，下图列出了每层主要的传输协议： <img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/2db9226a6cdb4ee48daecd9bc4181b64~tplv-k3u1fbpfcp-watermark.awebp" alt="img"></p>
<p>同样，<code v-pre>TCP/IP</code>五层协议的通信方式也是对等通信： <img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/2c0d79ff592242a8af294ce32177c8e3~tplv-k3u1fbpfcp-watermark.awebp" alt="image.png"></p>
<h2 id="六、tcp与udp" tabindex="-1"><a class="header-anchor" href="#六、tcp与udp" aria-hidden="true">#</a> 六、TCP与UDP</h2>
<h3 id="_1-tcp-和-udp的概念及特点" tabindex="-1"><a class="header-anchor" href="#_1-tcp-和-udp的概念及特点" aria-hidden="true">#</a> 1. TCP 和 UDP的概念及特点</h3>
...
<p><strong>5）头部开销小，传输数据报文时是很高效的。</strong> <img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/14d246d14aac47919989fc620fbb17dd~tplv-k3u1fbpfcp-watermark.awebp" alt="img"></p>
<p>UDP 头部包含了以下几个数据：</p>
<ul>
...
<h3 id="_2-tcp和udp的区别" tabindex="-1"><a class="header-anchor" href="#_2-tcp和udp的区别" aria-hidden="true">#</a> 2. TCP和UDP的区别</h3>
<table>
<thead>
<tr>
<th></th>
...
<h3 id="_3-tcp和udp的使用场景" tabindex="-1"><a class="header-anchor" href="#_3-tcp和udp的使用场景" aria-hidden="true">#</a> 3. TCP和UDP的使用场景</h3>
<ul>
...
<h3 id="_4-udp协议为什么不可靠" tabindex="-1"><a class="header-anchor" href="#_4-udp协议为什么不可靠" aria-hidden="true">#</a> 4. UDP协议为什么不可靠？</h3>
...
<h3 id="_5-tcp的重传机制" tabindex="-1"><a class="header-anchor" href="#_5-tcp的重传机制" aria-hidden="true">#</a> 5. TCP的重传机制</h3>
...
<h3 id="_6-tcp的拥塞控制机制" tabindex="-1"><a class="header-anchor" href="#_6-tcp的拥塞控制机制" aria-hidden="true">#</a> 6. TCP的拥塞控制机制</h3>
...
<li>无论是在慢开始阶段还是在拥塞避免阶段，只要发送方判断网络出现拥塞，就把慢开始门限设置为出现拥塞时的发送窗口大小的一半。然后把拥塞窗口设置为1，执行慢开始算法。如图所示: <img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/06b60b174bb242b498d244002caded1c~tplv-k3u1fbpfcp-watermark.awebp" alt="img"> 其中，判断网络出现拥塞的根据就是没有收到确认，虽然没有收到确认可能是其他原因的分组丢失，但是因为无法判定，所以都当做拥塞来处理。</li>
</ul>
...
<li>考虑到如果网络出现拥塞的话就不会收到好几个重复的确认，所以发送方现在认为网络可能没有出现拥塞。所以此时不执行慢开始算法，而是将cwnd设置为ssthresh的大小，然后执行拥塞避免算法。 <img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/d0f5339da8c741d19f416cac2af18e4f~tplv-k3u1fbpfcp-watermark.awebp" alt="img"></li>
</ul>
<h3 id="_7-tcp的流量控制机制" tabindex="-1"><a class="header-anchor" href="#_7-tcp的流量控制机制" aria-hidden="true">#</a> 7. TCP的流量控制机制</h3>
...
<h3 id="_8-tcp的可靠传输机制" tabindex="-1"><a class="header-anchor" href="#_8-tcp的可靠传输机制" aria-hidden="true">#</a> 8. TCP的可靠传输机制</h3>
...
<h3 id="_9-tcp的三次握手和四次挥手" tabindex="-1"><a class="header-anchor" href="#_9-tcp的三次握手和四次挥手" aria-hidden="true">#</a> 9. TCP的三次握手和四次挥手</h3>
<h4 id="_1-三次握手" tabindex="-1"><a class="header-anchor" href="#_1-三次握手" aria-hidden="true">#</a> （1）三次握手</h4>
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/55a81db348584e57abdd01c9555f1d5f~tplv-k3u1fbpfcp-watermark.awebp" alt="img"> 三次握手（Three-way Handshake）其实就是指建立一个TCP连接时，需要客户端和服务器总共发送3个包。进行三次握手的主要作用就是为了确认双方的接收能力和发送能力是否正常、指定自己的初始化序列号为后面的可靠性传送做准备。实质上其实就是连接服务器指定端口，建立TCP连接，并同步连接双方的序列号和确认号，交换TCP窗口大小信息。</p>
...
<h4 id="_2-四次挥手" tabindex="-1"><a class="header-anchor" href="#_2-四次挥手" aria-hidden="true">#</a> （2）四次挥手</h4>
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/a4190d0d324b427cb63154d3f84e47bc~tplv-k3u1fbpfcp-watermark.awebp" alt="img"> 刚开始双方都处于 ESTABLISHED 状态，假如是客户端先发起关闭请求。四次挥手的过程如下：</p>
<ul>
...
<h3 id="_10-tcp粘包是怎么回事-如何处理" tabindex="-1"><a class="header-anchor" href="#_10-tcp粘包是怎么回事-如何处理" aria-hidden="true">#</a> 10. TCP粘包是怎么回事，如何处理?</h3>
...
<h3 id="_11-为什么udp不会粘包" tabindex="-1"><a class="header-anchor" href="#_11-为什么udp不会粘包" aria-hidden="true">#</a> 11. 为什么<strong>udp</strong>不会粘包？</h3>
<ul>
...
<h2 id="七、websocket" tabindex="-1"><a class="header-anchor" href="#七、websocket" aria-hidden="true">#</a> 七、WebSocket</h2>
<h3 id="_1-对-websocket-的理解" tabindex="-1"><a class="header-anchor" href="#_1-对-websocket-的理解" aria-hidden="true">#</a> 1. 对 WebSocket 的理解</h3>
...
<p>在客户端中：</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token comment">// 在index.html中直接写WebSocket，设置服务端的端口号为 9999</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2-即时通讯的实现-短轮询、长轮询、sse-和-websocket-间的区别" tabindex="-1"><a class="header-anchor" href="#_2-即时通讯的实现-短轮询、长轮询、sse-和-websocket-间的区别" aria-hidden="true">#</a> 2. 即时通讯的实现：短轮询、长轮询、SSE 和 WebSocket 间的区别？</h3>
