<template><h1 id="vue篇-下" tabindex="-1"><a class="header-anchor" href="#vue篇-下" aria-hidden="true">#</a> Vue篇（下）</h1>
<h2 id="四、路由" tabindex="-1"><a class="header-anchor" href="#四、路由" aria-hidden="true">#</a> 四、路由</h2>
<h3 id="_1-vue-router-的懒加载如何实现" tabindex="-1"><a class="header-anchor" href="#_1-vue-router-的懒加载如何实现" aria-hidden="true">#</a> 1. Vue-Router 的懒加载如何实现</h3>
<p>非懒加载：</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">import</span> List <span class="token keyword">from</span> <span class="token string">'@/components/list.vue'</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br></div></div><p>（1）方案一(常用)：使用箭头函数+import动态加载</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">const</span> <span class="token function-variable function">List</span> <span class="token operator">=</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token operator">=></span> <span class="token keyword">import</span><span class="token punctuation">(</span><span class="token string">'@/components/list.vue'</span><span class="token punctuation">)</span>
<span class="token keyword">const</span> router <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">VueRouter</span><span class="token punctuation">(</span><span class="token punctuation">{</span>
  <span class="token literal-property property">routes</span><span class="token operator">:</span> <span class="token punctuation">[</span>
    <span class="token punctuation">{</span> <span class="token literal-property property">path</span><span class="token operator">:</span> <span class="token string">'/list'</span><span class="token punctuation">,</span> <span class="token literal-property property">component</span><span class="token operator">:</span> List <span class="token punctuation">}</span>
  <span class="token punctuation">]</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br></div></div><p>（2）方案二：使用箭头函数+require动态加载</p>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br></div></div><p>（3）方案三：使用webpack的require.ensure技术，也可以实现按需加载。 这种情况下，多个路由指定相同的chunkName，会合并打包成一个js文件。</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token comment">// r就是resolve</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br></div></div><h3 id="_2-路由的hash和history模式的区别" tabindex="-1"><a class="header-anchor" href="#_2-路由的hash和history模式的区别" aria-hidden="true">#</a> 2. 路由的hash和history模式的区别</h3>
<p>Vue-Router有两种模式：<strong>hash模式</strong>和<strong>history模式</strong>。默认的路由模式是hash模式。</p>
<h4 id="_1-hash模式" tabindex="-1"><a class="header-anchor" href="#_1-hash模式" aria-hidden="true">#</a> 1. hash模式</h4>
<p><strong>简介：</strong> hash模式是开发中默认的模式，它的URL带着一个#，例如：<a href="https://link.juejin.cn?target=http%3A%2F%2Fwww.abc.com%2F%23%2Fvue" target="_blank" rel="noopener noreferrer">www.abc.com/#/vue<ExternalLinkIcon/></a>，它的hash值就是<code>#/vue</code>。</p>
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>window<span class="token punctuation">.</span><span class="token function-variable function">onhashchange</span> <span class="token operator">=</span> <span class="token keyword">function</span><span class="token punctuation">(</span><span class="token parameter">event</span><span class="token punctuation">)</span><span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br></div></div><p>使用onhashchange()事件的好处就是，在页面的hash值发生变化时，无需向后端发起请求，window就可以监听事件的改变，并按规则加载相应的代码。除此之外，hash值变化对应的URL都会被浏览器记录下来，这样浏览器就能实现页面的前进和后退。虽然是没有请求后端服务器，但是页面的hash值和对应的URL关联起来了。</p>
<h4 id="_2-history模式" tabindex="-1"><a class="header-anchor" href="#_2-history模式" aria-hidden="true">#</a> 2. history模式</h4>
<p><strong>简介：</strong> history模式的URL中没有#，它使用的是传统的路由分发模式，即用户在输入一个URL时，服务器会接收这个请求，并解析这个URL，然后做出相应的逻辑处理。 <strong>特点：</strong> 当使用history模式时，URL就像这样：<a href="https://link.juejin.cn?target=http%3A%2F%2Fabc.com%2Fuser%2Fid" target="_blank" rel="noopener noreferrer">abc.com/user/id<ExternalLinkIcon/></a>。相比hash模式更加好看。但是，history模式需要后台配置支持。如果后台没有正确配置，访问时会返回404。 <strong>API：</strong> history api可以分为两大部分，切换历史状态和修改历史状态：</p>
<ul>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br></div></div><h4 id="_3-两种模式对比" tabindex="-1"><a class="header-anchor" href="#_3-两种模式对比" aria-hidden="true">#</a> 3. 两种模式对比</h4>
...
<h3 id="_3-如何获取页面的hash变化" tabindex="-1"><a class="header-anchor" href="#_3-如何获取页面的hash变化" aria-hidden="true">#</a> 3. 如何获取页面的hash变化</h3>
<p><strong>（1）监听$route的变化</strong></p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token comment">// 监听,当路由发生变化的时候执行</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br></div></div><p><strong>（2）window.location.hash读取#值</strong> window.location.hash 的值可读可写，读取来判断状态是否改变，写入时可以在不重载网页的前提下，添加一条历史访问记录。</p>
<h3 id="_4-route-和-router-的区别" tabindex="-1"><a class="header-anchor" href="#_4-route-和-router-的区别" aria-hidden="true">#</a> 4. <code>$route 和$router</code> 的区别</h3>
<ul>
<li>$route 是“路由信息对象”，包括 path，params，hash，query，fullPath，matched，name 等路由信息参数</li>
<li>$router 是“路由实例”对象包括了路由的跳转方法，钩子函数等。</li>
</ul>
<h3 id="_5-如何定义动态路由-如何获取传过来的动态参数" tabindex="-1"><a class="header-anchor" href="#_5-如何定义动态路由-如何获取传过来的动态参数" aria-hidden="true">#</a> 5. 如何定义动态路由？如何获取传过来的动态参数？</h3>
...
<p>1）路由定义</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token comment">//在APP.vue中</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br></div></div><p>2）路由跳转</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token comment">// 方法1：</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br></div></div><p>3）参数获取 通过 <code>$route.params.userid</code> 获取传递的值</p>
...
<p>1）路由定义</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token comment">//方式1：直接在router-link 标签上以对象的形式</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br></div></div><p>2）跳转方法</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token comment">// 方法1：</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br></div></div><p>3）获取参数</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>通过$route<span class="token punctuation">.</span>query 获取传递的值

</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br></div></div><h3 id="_6-vue-router-路由钩子在生命周期的体现" tabindex="-1"><a class="header-anchor" href="#_6-vue-router-路由钩子在生命周期的体现" aria-hidden="true">#</a> 6. Vue-router 路由钩子在生命周期的体现</h3>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br></div></div><p>二、Vue路由钩子在生命周期函数的体现</p>
<ol>
...
<h3 id="_7-vue-router跳转和location-href有什么区别" tabindex="-1"><a class="header-anchor" href="#_7-vue-router跳转和location-href有什么区别" aria-hidden="true">#</a> 7. Vue-router跳转和location.href有什么区别</h3>
<ul>
...
<h3 id="_8-params和query的区别" tabindex="-1"><a class="header-anchor" href="#_8-params和query的区别" aria-hidden="true">#</a> 8. params和query的区别</h3>
...
<h3 id="_9-vue-router-导航守卫有哪些" tabindex="-1"><a class="header-anchor" href="#_9-vue-router-导航守卫有哪些" aria-hidden="true">#</a> 9. Vue-router 导航守卫有哪些</h3>
<ul>
...
<h3 id="_10-对前端路由的理解" tabindex="-1"><a class="header-anchor" href="#_10-对前端路由的理解" aria-hidden="true">#</a> 10. 对前端路由的理解</h3>
...
<h2 id="五、vuex" tabindex="-1"><a class="header-anchor" href="#五、vuex" aria-hidden="true">#</a> 五、Vuex</h2>
<h3 id="_1-vuex-的原理" tabindex="-1"><a class="header-anchor" href="#_1-vuex-的原理" aria-hidden="true">#</a> 1. Vuex 的原理</h3>
...
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/92fc4b2c6e414344b9b22bc057dcd39c~tplv-k3u1fbpfcp-watermark.awebp" alt="b025e120ca3d0bd2ded3d038d58cacf4.jpg"> Vuex为Vue Components建立起了一个完整的生态圈，包括开发中的API调用一环。 <strong>（1）核心流程中的主要功能：</strong></p>
<ul>
...
<h3 id="_2-vuex中action和mutation的区别" tabindex="-1"><a class="header-anchor" href="#_2-vuex中action和mutation的区别" aria-hidden="true">#</a> 2. Vuex中action和mutation的区别</h3>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br></div></div><p>当触发一个类型为 increment 的 mutation 时，需要调用此函数：</p>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br></div></div><p>而Action类似于mutation，不同点在于：</p>
<ul>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br></div></div><p>Action 函数接受一个与 store 实例具有相同方法和属性的 context 对象，因此你可以调用 context.commit 提交一个 mutation，或者通过 context.state 和 context.getters 来获取 state 和 getters。 所以，两者的不同点如下：</p>
<ul>
...
<h3 id="_3-vuex-和-localstorage-的区别" tabindex="-1"><a class="header-anchor" href="#_3-vuex-和-localstorage-的区别" aria-hidden="true">#</a> 3. Vuex 和 localStorage 的区别</h3>
...
<h3 id="_4-redux-和-vuex-有什么区别-它们的共同思想" tabindex="-1"><a class="header-anchor" href="#_4-redux-和-vuex-有什么区别-它们的共同思想" aria-hidden="true">#</a> 4. Redux 和 Vuex 有什么区别，它们的共同思想</h3>
...
<h3 id="_5-为什么要用-vuex-或者-redux" tabindex="-1"><a class="header-anchor" href="#_5-为什么要用-vuex-或者-redux" aria-hidden="true">#</a> 5. 为什么要用 Vuex 或者 Redux</h3>
...
<h3 id="_6-vuex有哪几种属性" tabindex="-1"><a class="header-anchor" href="#_6-vuex有哪几种属性" aria-hidden="true">#</a> 6. Vuex有哪几种属性？</h3>
...
<h3 id="_7-vuex和单纯的全局对象有什么区别" tabindex="-1"><a class="header-anchor" href="#_7-vuex和单纯的全局对象有什么区别" aria-hidden="true">#</a> 7. Vuex和单纯的全局对象有什么区别？</h3>
<ul>
<li>Vuex 的状态存储是响应式的。当 Vue 组件从 store 中读取状态的时候，若 store 中的状态发生变化，那么相应的组件也会相应地得到高效更新。</li>
<li>不能直接改变 store 中的状态。改变 store 中的状态的唯一途径就是显式地提交 (commit) mutation。这样可以方便地跟踪每一个状态的变化，从而能够实现一些工具帮助更好地了解我们的应用。</li>
</ul>
<h3 id="_8-为什么-vuex-的-mutation-中不能做异步操作" tabindex="-1"><a class="header-anchor" href="#_8-为什么-vuex-的-mutation-中不能做异步操作" aria-hidden="true">#</a> 8. 为什么 Vuex 的 mutation 中不能做异步操作？</h3>
<ul>
...
<h3 id="_9-vuex的严格模式是什么-有什么作用-如何开启" tabindex="-1"><a class="header-anchor" href="#_9-vuex的严格模式是什么-有什么作用-如何开启" aria-hidden="true">#</a> 9. Vuex的严格模式是什么,有什么作用，如何开启？</h3>
<p>在严格模式下，无论何时发生了状态变更且不是由mutation函数引起的，将会抛出错误。这能保证所有的状态变更都能被调试工具跟踪到。</p>
<p>在Vuex.Store 构造器选项中开启,如下</p>
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>const store = new Vuex.Store({
    strict:true,
})

</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br></div></div><h3 id="_10-如何在组件中批量使用vuex的getter属性" tabindex="-1"><a class="header-anchor" href="#_10-如何在组件中批量使用vuex的getter属性" aria-hidden="true">#</a> 10. 如何在组件中批量使用Vuex的getter属性</h3>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br></div></div><h3 id="_11-如何在组件中重复使用vuex的mutation" tabindex="-1"><a class="header-anchor" href="#_11-如何在组件中重复使用vuex的mutation" aria-hidden="true">#</a> 11. 如何在组件中重复使用Vuex的mutation</h3>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br></div></div><p>然后调用<code>this.setNumber(10)</code>相当调用<code>this.$store.commit('SET_NUMBER',10)</code></p>
<h2 id="六、vue-3-0" tabindex="-1"><a class="header-anchor" href="#六、vue-3-0" aria-hidden="true">#</a> 六、Vue 3.0</h2>
<h3 id="_1-vue3-0有什么更新" tabindex="-1"><a class="header-anchor" href="#_1-vue3-0有什么更新" aria-hidden="true">#</a> 1. Vue3.0有什么更新</h3>
...
<h3 id="_2-defineproperty和proxy的区别" tabindex="-1"><a class="header-anchor" href="#_2-defineproperty和proxy的区别" aria-hidden="true">#</a> 2. defineProperty和proxy的区别</h3>
...
<h3 id="_3-vue3-0-为什么要用-proxy" tabindex="-1"><a class="header-anchor" href="#_3-vue3-0-为什么要用-proxy" aria-hidden="true">#</a> 3. Vue3.0 为什么要用 proxy？</h3>
...
<h3 id="_4-vue-3-0-中的-vue-composition-api" tabindex="-1"><a class="header-anchor" href="#_4-vue-3-0-中的-vue-composition-api" aria-hidden="true">#</a> 4.  Vue 3.0 中的 Vue Composition API？</h3>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br></div></div><p>显而易见，Vue Composition API 使得 Vue3 的开发风格更接近于原生 JavaScript，带给开发者更多地灵活性</p>
<h3 id="_5-composition-api与react-hook很像-区别是什么" tabindex="-1"><a class="header-anchor" href="#_5-composition-api与react-hook很像-区别是什么" aria-hidden="true">#</a> 5. Composition API与React Hook很像，区别是什么</h3>
...
<h2 id="七、虚拟dom" tabindex="-1"><a class="header-anchor" href="#七、虚拟dom" aria-hidden="true">#</a> 七、虚拟DOM</h2>
<h3 id="_1-对虚拟dom的理解" tabindex="-1"><a class="header-anchor" href="#_1-对虚拟dom的理解" aria-hidden="true">#</a> 1. 对虚拟DOM的理解？</h3>
...
<h3 id="_2-虚拟dom的解析过程" tabindex="-1"><a class="header-anchor" href="#_2-虚拟dom的解析过程" aria-hidden="true">#</a> 2. 虚拟DOM的解析过程</h3>
<p>虚拟DOM的解析过程：</p>
<ul>
...
<h3 id="_3-为什么要用虚拟dom" tabindex="-1"><a class="header-anchor" href="#_3-为什么要用虚拟dom" aria-hidden="true">#</a> 3. 为什么要用虚拟DOM</h3>
<p><strong>（1）保证性能下限，在不进行手动优化的情况下，提供过得去的性能</strong> 看一下页面渲染的流程：<strong>解析HTML -&gt; 生成DOM -&gt; 生成 CSSOM -&gt; Layout -&gt; Paint -&gt; Compiler</strong> 下面对比一下修改DOM时真实DOM操作和Virtual DOM的过程，来看一下它们重排重绘的性能消耗∶</p>
<ul>
<li>真实DOM∶ 生成HTML字符串＋重建所有的DOM元素</li>
<li>虚拟DOM∶ 生成vNode+ DOMDiff＋必要的dom更新</li>
</ul>
<p>Virtual DOM的更新DOM的准备工作耗费更多的时间，也就是JS层面，相比于更多的DOM操作它的消费是极其便宜的。尤雨溪在社区论坛中说道∶ 框架给你的保证是，你不需要手动优化的情况下，依然可以给你提供过得去的性能。 <strong>（2）跨平台</strong> Virtual DOM本质上是JavaScript的对象，它可以很方便的跨平台操作，比如服务端渲染、uniapp等。</p>
<h3 id="_4-虚拟dom真的比真实dom性能好吗" tabindex="-1"><a class="header-anchor" href="#_4-虚拟dom真的比真实dom性能好吗" aria-hidden="true">#</a> 4. 虚拟DOM真的比真实DOM性能好吗</h3>
<ul>
<li>首次渲染大量DOM时，由于多了一层虚拟DOM的计算，会比innerHTML插入慢。</li>
<li>正如它能保证性能下限，在真实DOM操作的时候进行针对性的优化时，还是更快的。</li>
</ul>
<h3 id="_5-diff算法的原理" tabindex="-1"><a class="header-anchor" href="#_5-diff算法的原理" aria-hidden="true">#</a> 5. DIFF算法的原理</h3>
<p>在新老虚拟DOM对比时：</p>
<ul>
...
<h3 id="_6-vue中key的作用" tabindex="-1"><a class="header-anchor" href="#_6-vue中key的作用" aria-hidden="true">#</a> 6. Vue中key的作用</h3>
...
<h3 id="_7-为什么不建议用index作为key" tabindex="-1"><a class="header-anchor" href="#_7-为什么不建议用index作为key" aria-hidden="true">#</a> 7. 为什么不建议用index作为key?</h3>
