<template><h1 id="前端性能优化篇" tabindex="-1"><a class="header-anchor" href="#前端性能优化篇" aria-hidden="true">#</a> 前端性能优化篇</h1>
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/26a6e0fe7cfc48c4b7702d88a3dd21dd~tplv-k3u1fbpfcp-watermark.awebp" alt="性能优化面试题.png"></p>
<h2 id="一、cdn" tabindex="-1"><a class="header-anchor" href="#一、cdn" aria-hidden="true">#</a> 一、CDN</h2>
<h3 id="_1-cdn的概念" tabindex="-1"><a class="header-anchor" href="#_1-cdn的概念" aria-hidden="true">#</a> 1. CDN的概念</h3>
...
<h3 id="_2-cdn的作用" tabindex="-1"><a class="header-anchor" href="#_2-cdn的作用" aria-hidden="true">#</a> 2. CDN的作用</h3>
...
<h3 id="_3-cdn的原理" tabindex="-1"><a class="header-anchor" href="#_3-cdn的原理" aria-hidden="true">#</a> 3. CDN的原理</h3>
<p>CDN和DNS有着密不可分的联系，先来看一下DNS的解析域名过程，在浏览器输入 <a href="https://link.juejin.cn?target=http%3A%2F%2Fwww.test.com" target="_blank" rel="noopener noreferrer">www.test.com<ExternalLinkIcon/></a> 的解析过程如下： （1） 检查浏览器缓存 （2）检查操作系统缓存，常见的如hosts文件 （3）检查路由器缓存 （4）如果前几步都没没找到，会向ISP(网络服务提供商)的LDNS服务器查询 （5）如果LDNS服务器没找到，会向根域名服务器(Root Server)请求解析，分为以下几步：</p>
<ul>
...
<p><strong>CDN的工作原理：</strong> （1）用户未使用CDN缓存资源的过程：</p>
<ol>
...
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/a4635b395fb64aaab8417f63e64291d4~tplv-k3u1fbpfcp-watermark.awebp" alt="img"> CNAME（意为：别名）：在域名解析中，实际上解析出来的指定域名对应的IP地址，或者该域名的一个CNAME，然后再根据这个CNAME来查找对应的IP地址。</p>
<h3 id="_4-cdn的使用场景" tabindex="-1"><a class="header-anchor" href="#_4-cdn的使用场景" aria-hidden="true">#</a> 4. CDN的使用场景</h3>
<ul>
...
<h2 id="二、懒加载" tabindex="-1"><a class="header-anchor" href="#二、懒加载" aria-hidden="true">#</a> 二、懒加载</h2>
<h3 id="_1-懒加载的概念" tabindex="-1"><a class="header-anchor" href="#_1-懒加载的概念" aria-hidden="true">#</a> 1. 懒加载的概念</h3>
...
<h3 id="_2-懒加载的特点" tabindex="-1"><a class="header-anchor" href="#_2-懒加载的特点" aria-hidden="true">#</a> 2. 懒加载的特点</h3>
<ul>
...
<h3 id="_3-懒加载的实现原理" tabindex="-1"><a class="header-anchor" href="#_3-懒加载的实现原理" aria-hidden="true">#</a> 3. 懒加载的实现原理</h3>
...
<p><strong>图示：</strong> <img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/efbcb31418be45eaa848d107b107c4eb~tplv-k3u1fbpfcp-watermark.awebp" alt="img"> <strong>代码实现：</strong></p>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br></div></div><h3 id="_4-懒加载与预加载的区别" tabindex="-1"><a class="header-anchor" href="#_4-懒加载与预加载的区别" aria-hidden="true">#</a> 4. 懒加载与预加载的区别</h3>
...
<h2 id="三、回流与重绘" tabindex="-1"><a class="header-anchor" href="#三、回流与重绘" aria-hidden="true">#</a> 三、回流与重绘</h2>
<h3 id="_1-回流与重绘的概念及触发条件" tabindex="-1"><a class="header-anchor" href="#_1-回流与重绘的概念及触发条件" aria-hidden="true">#</a> 1. 回流与重绘的概念及触发条件</h3>
<h4 id="_1-回流" tabindex="-1"><a class="header-anchor" href="#_1-回流" aria-hidden="true">#</a> （1）回流</h4>
...
<h4 id="_2-重绘" tabindex="-1"><a class="header-anchor" href="#_2-重绘" aria-hidden="true">#</a> （2）重绘</h4>
...
<h3 id="_2-如何避免回流与重绘" tabindex="-1"><a class="header-anchor" href="#_2-如何避免回流与重绘" aria-hidden="true">#</a> 2. 如何避免回流与重绘？</h3>
...
<h3 id="_3-如何优化动画" tabindex="-1"><a class="header-anchor" href="#_3-如何优化动画" aria-hidden="true">#</a> 3. 如何优化动画？</h3>
...
<h3 id="_4-documentfragment-是什么-用它跟直接操作-dom-的区别是什么" tabindex="-1"><a class="header-anchor" href="#_4-documentfragment-是什么-用它跟直接操作-dom-的区别是什么" aria-hidden="true">#</a> 4. documentFragment 是什么？用它跟直接操作 DOM 的区别是什么？</h3>
...
<h2 id="四、节流与防抖" tabindex="-1"><a class="header-anchor" href="#四、节流与防抖" aria-hidden="true">#</a> 四、节流与防抖</h2>
<h3 id="_1-对节流与防抖的理解" tabindex="-1"><a class="header-anchor" href="#_1-对节流与防抖的理解" aria-hidden="true">#</a> 1. 对节流与防抖的理解</h3>
<ul>
...
<h3 id="_2-实现节流函数和防抖函数" tabindex="-1"><a class="header-anchor" href="#_2-实现节流函数和防抖函数" aria-hidden="true">#</a> 2. 实现节流函数和防抖函数</h3>
<p><strong>函数防抖的实现：</strong></p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">function</span> <span class="token function">debounce</span><span class="token punctuation">(</span><span class="token parameter">fn<span class="token punctuation">,</span> wait</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br></div></div><p><strong>函数节流的实现：</strong></p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token comment">// 时间戳版</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br></div></div><h2 id="五、图片优化" tabindex="-1"><a class="header-anchor" href="#五、图片优化" aria-hidden="true">#</a> 五、图片优化</h2>
<h3 id="_1-如何对项目中的图片进行优化" tabindex="-1"><a class="header-anchor" href="#_1-如何对项目中的图片进行优化" aria-hidden="true">#</a> 1. 如何对项目中的图片进行优化？</h3>
<ol>
...
<h3 id="_2-常见的图片格式及使用场景" tabindex="-1"><a class="header-anchor" href="#_2-常见的图片格式及使用场景" aria-hidden="true">#</a> 2. 常见的图片格式及使用场景</h3>
...
<h2 id="六、webpack优化" tabindex="-1"><a class="header-anchor" href="#六、webpack优化" aria-hidden="true">#</a> 六、Webpack优化</h2>
<h3 id="_1-如何提高webpack的打包速度" tabindex="-1"><a class="header-anchor" href="#_1-如何提高webpack的打包速度" aria-hidden="true">#</a> 1. 如何提⾼<strong>webpack</strong>的打包速度?</h3>
<h4 id="_1-优化-loader" tabindex="-1"><a class="header-anchor" href="#_1-优化-loader" aria-hidden="true">#</a> （1）优化 Loader</h4>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br></div></div><p>对于 Babel 来说，希望只作用在 JS 代码上的，然后 <code>node_modules</code> 中使用的代码都是编译过的，所以完全没有必要再去处理一遍。</p>
<p>当然这样做还不够，还可以将 Babel 编译过的文件<strong>缓存</strong>起来，下次只需要编译更改过的代码文件即可，这样可以大幅度加快打包时间</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token literal-property property">loader</span><span class="token operator">:</span> <span class="token string">'babel-loader?cacheDirectory=true'</span>

</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br></div></div><h4 id="_2-happypack" tabindex="-1"><a class="header-anchor" href="#_2-happypack" aria-hidden="true">#</a> （2）HappyPack</h4>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br></div></div><h4 id="_3-dllplugin" tabindex="-1"><a class="header-anchor" href="#_3-dllplugin" aria-hidden="true">#</a> （3）DllPlugin</h4>
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token comment">// 单独配置在一个文件中</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br></div></div><p>然后需要执行这个配置文件生成依赖文件，接下来需要使用 <code>DllReferencePlugin</code> 将依赖文件引入项目中</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token comment">// webpack.conf.js</span>
module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span>
...
<h4 id="_5-其他" tabindex="-1"><a class="header-anchor" href="#_5-其他" aria-hidden="true">#</a> （5）其他</h4>
...
<h3 id="_2-如何减少-webpack-打包体积" tabindex="-1"><a class="header-anchor" href="#_2-如何减少-webpack-打包体积" aria-hidden="true">#</a> 2. 如何减少 Webpack 打包体积</h3>
<h4 id="_1-按需加载" tabindex="-1"><a class="header-anchor" href="#_1-按需加载" aria-hidden="true">#</a> （1）按需加载</h4>
...
<h4 id="_2-scope-hoisting" tabindex="-1"><a class="header-anchor" href="#_2-scope-hoisting" aria-hidden="true">#</a> （2）Scope Hoisting</h4>
<p><strong>Scope Hoisting 会分析出模块之间的依赖关系，尽可能的把打包出来的模块合并到一个函数中去。</strong></p>
<p>比如希望打包两个文件：</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token comment">// test.js</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br></div></div><p>对于这种情况，打包出来的代码会类似这样：</p>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br></div></div><p>但是如果使用 Scope Hoisting ，代码就会尽可能的合并到一个函数中去，也就变成了这样的类似代码：</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token punctuation">[</span>
  <span class="token comment">/* 0 */</span>
  <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token parameter">module<span class="token punctuation">,</span> exports<span class="token punctuation">,</span> require</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
    <span class="token comment">//...</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br></div></div><p>这样的打包方式生成的代码明显比之前的少多了。如果在 Webpack4 中你希望开启这个功能，只需要启用 <code>optimization.concatenateModules</code> 就可以了：</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br></div></div><h4 id="_3-tree-shaking" tabindex="-1"><a class="header-anchor" href="#_3-tree-shaking" aria-hidden="true">#</a> （3）Tree Shaking</h4>
<p><strong>Tree Shaking 可以实现删除项目中未被引用的代码</strong>，比如：</p>
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>// test.js
export const a = 1
export const b = 2
// index.js
import { a } from './test.js'

</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br></div></div><p>对于以上情况，<code>test</code> 文件中的变量 <code>b</code> 如果没有在项目中使用到的话，就不会被打包到文件中。</p>
<p>如果使用 Webpack 4 的话，开启生产环境就会自动启动这个优化功能。</p>
<h3 id="_3-如何用webpack来优化前端性能" tabindex="-1"><a class="header-anchor" href="#_3-如何用webpack来优化前端性能" aria-hidden="true">#</a> 3. 如何⽤<strong>webpack</strong>来优化前端性能？</h3>
...
<h3 id="_4-如何提高webpack的构建速度" tabindex="-1"><a class="header-anchor" href="#_4-如何提高webpack的构建速度" aria-hidden="true">#</a> 4. 如何提⾼<strong>webpack</strong>的构建速度？</h3>
<ol>
...
<p>代码层面：视图层比如vue层渲染循环加key
网络节流：节流函数，减少网络请求，promise.all,
模块懒加载，路由懒加载，图片懒加载
减少回流重绘</p>
</template>
