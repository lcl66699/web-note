<template><h1 id="react" tabindex="-1"><a class="header-anchor" href="#react" aria-hidden="true">#</a> React</h1>
<p>安个vs的小插件   安好输入rcc  可快捷创建类 rfc快速创建函数</p>
<h2 id="react介绍" tabindex="-1"><a class="header-anchor" href="#react介绍" aria-hidden="true">#</a> React介绍</h2>
<p>Facebook,React主要是用于构建用户界面的JavaScript 库，实现单页面应用。于 2013 年 5 月开源</p>
<p>React 拥有较高的性能:</p>
<ol>
...
<li>单页面应用和多页面应用
<ul>
<li>多页面应用:页面跳转时跳转的都是完整的html页面</li>
<li>单页面应用:只有1个html页面，所有内容都在这个页面中展示，通过“路由”来加载不同内容。全部是通过js来控制显示的。</li>
</ul>
</li>
<li>单页面应用的优缺点:
<ul>
<li>优点:用户体验比较好，加载比较流畅</li>
<li>缺点:不利于seo(网站优化，能影响搜索排名)</li>
</ul>
</li>
<li>特点:声明式设计(采用声明范式)、高效、灵活、JSX语法、组件、单向响应的数据流
创建项目,脚手架：下载别人写好的配置
<code>npm i -g yarn</code>先安这个 再安下面的更快</li>
</ul>
<p><code>npx create-react-app my-app</code></p>
<p>安装时还可以先把脚手架下载好，再通过脚手架下载项目</p>
<p><code>npm i -g create - react -app</code>
<code>create -react- app my- appcreate -react- app my- app</code></p>
<p>npx: npm中的个功能，npx的执行分3步，第一步:下载脚手架，第二步: 使用脚手架安装项目。第三步:下载好项目后删除脚手架。</p>
<h2 id="jsx语法" tabindex="-1"><a class="header-anchor" href="#jsx语法" aria-hidden="true">#</a> jsx语法</h2>
<ol>
<li>在js中可以直接写html
<ul>
<li>HTML部分:直接写html标签</li>
<li>JS部分:写在{}内</li>
<li>babel会把j sx转成React. createElement( )</li>
<li>React. createElement()方法是创建react元素(虚拟DOM)的方法</li>
<li>ReactDOM. render()的第一 个参数，需要的就是react元素</li>
</ul>
</li>
<li>jsx的特点
<ul>
<li>
<p>大括号中写的js表达式,注意，大括号中不能直接渲染对象，能渲染数组(不能有普通对象)</p>
</li>
<li>
<p>JSX属性：写在标签的属性上</p>
<ul>
<li>改名<code>&lt;div className=''&gt;&lt;/div&gt;</code>  <code>&lt;label htmlfor=''&gt;&lt;/label&gt;</code></li>
<li>标签上添加行内样式时，需要使用对象形式</li>
<li><code>&lt;div id={uid}  style={color:'red',fontSize:'14px'}&gt;&lt;/div&gt;</code></li>
</ul>
</li>
<li>
<p>react元素是不可变的,如果需要更新页面显示，就需要创建新的react元素</p>
</li>
</ul>
</li>
<li>元素渲染
...
react元素写法:
<ul>
<li>直接使用jsx语法: <code>&lt;div&gt;{uname}&lt;/div&gt;</code></li>
<li>使用 <code>React. createElement()</code></li>
</ul>
</li>
<li>使用组件<code>&lt;App /&gt;</code>
<code>ReactDOM.render(&lt;Home/&gt;,document.getElementById('root'))</code></li>
</ol>
<h2 id="组件" tabindex="-1"><a class="header-anchor" href="#组件" aria-hidden="true">#</a> 组件</h2>
<ol>
<li>概念:从概念上类似于JavaScript 函数。它接受任意的入参(即&quot;props&quot;) ，并返回用于描述页面展示内容的React元素。组件允许你将UI拆分为独立可复用的代码片段，并对每个片段进行独立构思。</li>
<li>创建方式</li>
</ol>
<ul>
<li>函数式组件</li>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br></div></div><p>函数组件不用hook语法时，功能弱j，有hook语法后 替代类形式组件。</p>
<ul>
<li>类形式组件 rcc</li>
</ul>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br></div></div><p>前期使用类组件，会学习类组件中的state,生命周期函数。不管什么组件 必须引入react7</p>
<h3 id="类形式组件" tabindex="-1"><a class="header-anchor" href="#类形式组件" aria-hidden="true">#</a> 类形式组件</h3>
<h4 id="创建组件rcc" tabindex="-1"><a class="header-anchor" href="#创建组件rcc" aria-hidden="true">#</a> 创建组件rcc</h4>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">class</span> <span class="token class-name">Home</span> <span class="token keyword">extends</span> <span class="token class-name">React<span class="token punctuation">.</span>Component</span><span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br></div></div><p>说明：</p>
<ol>
<li>组件名称首字母要求大写</li>
<li>需要继承React.Component这个类</li>
<li>必须有一个render函数，render必须return，return后写的是jsx语法</li>
</ol>
<h4 id="导出组件" tabindex="-1"><a class="header-anchor" href="#导出组件" aria-hidden="true">#</a> 导出组件</h4>
<p><code>export {Home}</code>
<code>export default Home</code></p>
<h4 id="导入组件" tabindex="-1"><a class="header-anchor" href="#导入组件" aria-hidden="true">#</a> 导入组件</h4>
<p><code>import {Home} from 'path'</code>
<code>import AppHome from 'path'</code></p>
<h4 id="使用组件-当成标签使用" tabindex="-1"><a class="header-anchor" href="#使用组件-当成标签使用" aria-hidden="true">#</a> 使用组件,当成标签使用</h4>
<p><code>&lt;Home /&gt;</code>
<code>&lt;Home&gt;&lt;/Home&gt;</code></p>
<h4 id="组件复用" tabindex="-1"><a class="header-anchor" href="#组件复用" aria-hidden="true">#</a> 组件复用</h4>
<p>把页面中的某一块UI拆分出去，做成一个组件，在原来的位置调用组件即可。</p>
<h3 id="props" tabindex="-1"><a class="header-anchor" href="#props" aria-hidden="true">#</a> props</h3>
<ul>
<li>当React元素为用户自定义组件时，它会将JSX 所接收的属性(attributes) 转换为单个对象传递给组件，这个对象被称之为“props”。</li>
<li>调用组件时可以通过属性的形式定义传递数据
<code>&lt;Item data='string' arr={[1,2,3,4]}  /&gt;</code>
<code>&lt;Item picurl={arr[0].picurl} title={arr[0].title} /&gt;</code></li>
</ul>
<p>在Item组件可以通过props对象，获取到用户调用组件时传入的数据</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">class</span> <span class="token class-name">Item</span> <span class="token keyword">extends</span> <span class="token class-name">Component</span><span class="token punctuation">{</span>
...
<li>传递数据时，多个组件调用定义的属性名要一致。</li>
<li>可以使用 ... 扩展运算符</li>
<li>还可以遍历时传递数据</li>
<li>props是只读属性</li>
</ul>
<h2 id="jsx中的循环" tabindex="-1"><a class="header-anchor" href="#jsx中的循环" aria-hidden="true">#</a> JSX中的循环</h2>
<p>不能使用for循环,使用map()方法遍历对象或数组
<code>arr/obj.map(function(item,index){     return item })</code></p>
<h2 id="state" tabindex="-1"><a class="header-anchor" href="#state" aria-hidden="true">#</a> state</h2>
<ul>
<li>state是定义组件内部自己使用的数据</li>
<li>在类组件中有两种定义方式
<ul>
<li>第一种：在constructor方法中定义</li>
</ul>
</li>
</ul>
...
<li>使用state数据
<code>this.state.xx</code></li>
<li>修改state数据,必须！this.setState()方法
<ul>
<li>用法1：对象形式的，多次调用 只加一次</li>
</ul>
</li>
</ul>
...
<li>用法2：函数形式的,拿到更新前的值，多次调用可以一直加</li>
</ul>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">this</span><span class="token punctuation">.</span><span class="token function">setState</span><span class="token punctuation">(</span><span class="token punctuation">(</span>state<span class="token punctuation">)</span><span class="token operator">=</span><span class="token punctuation">{</span>
...
<li>this.setState()方法有批量更新功能</li>
</ul>
<p><code>this.setState({count:this.state.count+1})</code></p>
<ul>
<li>this.setState()方法 可能是异步的</li>
</ul>
<p><code>this.setState({},()=&gt;{})</code></p>
<p>什么时候是异步的：不放在其他宏任务或微任务中 当setState直接放在事件的宏任务中执行时，是异步的</p>
<p>什么时候是同步的：setState又被放在别的宏任务中,或者其他的微任务中</p>
<ul>
<li>setState的函数形式：</li>
</ul>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">this</span><span class="token punctuation">.</span><span class="token function">setState</span><span class="token punctuation">(</span><span class="token punctuation">(</span>state<span class="token punctuation">)</span><span class="token operator">=</span><span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br></div></div><p>函数中有一个参数state,这个state是谁?</p>
<p>state是上一次操作完state的结果(永远是最新的数据)
加this不累加,算最后一个;不加this的话,就累加加的多</p>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br></div></div><p>如果视图内的数据需要修改, 并且同时页面响应变化，我们需要将数据放在state中, 使用setState来修改数据。</p>
...
<p>又叫钩子函数，在组件运行的过程会在某些指定的条件下自动触发执行。
组件有三个生命周期函数一生只触发一次：</p>
<ul>
...
<ul>
<li>componentWillMount 组件挂载到DOM前调用,只会被调用一次, 这里写setState不会引起组件重新渲染,组件渲染前，可能会放网络请求(不太建议)</li>
<li>componentDidMount 组件渲染完成，网络请求，全局事件绑定, 且只会被调用一次</li>
<li>shouldComponentUpdate(nextProps, nextState){return false;} 是否允许组件更新，优化使用,比较之前和当前的props state是否有变化</li>
<li>componentWillUpdate(){} render方法前执行,更新前，一般不做任何处理
- componentDidUpdate(){} 组件更新完成，新网络请求
- componentWillReceiveProps(){}props改变了 接收新的props，一般不做任何处理</li>
<li>componentWillUnmount(){} 组件销毁前，清理一些定时器,把全局绑定的事件、网络请求等有副作用的全部清除</li>
</ul>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br><span class="line-number">41</span><br><span class="line-number">42</span><br></div></div><p>Fiber：</p>
<p>getDerivedStateFromProps(props,state)</p>
<p>在组件创建和更新的render之前调用</p>
<h3 id="事件系统" tabindex="-1"><a class="header-anchor" href="#事件系统" aria-hidden="true">#</a> 事件系统</h3>
<ul>
<li>react中自己重新定义事件系统，react绑定事件不需要获取到DOM元素，而是把事件绑定定义在虛拟DOM上了</li>
<li>语法:
<code>&lt;div on+事件名={EventFunction}&gt;&lt;/div&gt;</code>
说明：</li>
</ul>
<ol>
<li>js的事件，驼峰命名法</li>
<li>EventFunction:对应的事件功能，编写的形式
<ol>
<li>直接定义一个箭头函数</li>
<li>可以定义函数
如果是类形式组件，需要使用this.clickme, clickme函数定义在类中</li>
</ol>
</li>
</ol>
...
</span></code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br></div></div><h3 id="this指向问题" tabindex="-1"><a class="header-anchor" href="#this指向问题" aria-hidden="true">#</a> this指向问题</h3>
<p>在react中，自定义事件中this默认是指向undefined的。</p>
<ul>
<li>在react组件的生命周期函数中，this指向当前组件</li>
<li>在react class定义的组件中，constructor构造方法中需要通过调用super()方法生成this，这时	this指向当前组件；否则不存在this，使用会报错。</li>
<li>在react 组件中，自定义function函数中this默认指向undefined）</li>
</ul>
<p>如果想让this指向当前组件</p>
<ul>
<li>方法1:使用bind,改变this指向</li>
<li>方法2：使用箭头函数</li>
<li>方法3：在constructor构造方法中通过bind绑定this</li>
</ul>
<div class="language-jsx ext-jsx line-numbers-mode"><pre v-pre class="language-jsx"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>div</span> <span class="token attr-name">onClick</span><span class="token script language-javascript"><span class="token script-punctuation punctuation">=</span><span class="token punctuation">{</span><span class="token keyword">this</span><span class="token punctuation">.</span>clickme <span class="token punctuation">}</span></span><span class="token punctuation">></span></span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">></span></span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br></div></div><p>如果当函数调用时没有传参，建议使用方法3(constructor中绑定)
如果函数调用时需要传参，使用直接bind绑定更多一些</p>
<h3 id="事件对象" tabindex="-1"><a class="header-anchor" href="#事件对象" aria-hidden="true">#</a> 事件对象</h3>
<ul>
<li>事件对象不需要传递，直接调用就行，把事件对象方法函数形参的最后y一个位置</li>
<li>获取坐标信息</li>
</ul>
<p><code>event.pagex / event . pageY</code>获取事件触发者</p>
<p><code>e.preventDefault()</code>阻止冒泡</p>
<p><code>e.stopPropagation()</code> 阻止默认事件</p>
<h3 id="表单" tabindex="-1"><a class="header-anchor" href="#表单" aria-hidden="true">#</a> 表单</h3>
<ul>
<li>form标签
<code>&lt;form action= 'http://xx/xx.php/xx. jsp/xx.asp' method= 'get post' &gt;&lt;/ form&gt;</code></li>
<li>ajax:不刷新页面，能实现页面的局部更新，有ajax后form用的很少了</li>
<li>表单:收集用户输入的信息
<ul>
<li>
<p>第一种收集信息的形式：受控组件</p>
<p>受控组件：表单数据的显示和更改有react控制，具体是由react的state的控制。使 React 的 state 成为“唯一数据源”。</p>
<p><code>&lt;input value={this.state.user} onChange={(e)=&gt;this.setState({user:e.currentTarget.vale})} /&gt;</code>
特殊的受控组件：单选按钮,多选按钮</p>
<ul>
<li>value属性值不能改变</li>
<li>onChange事件只有在选中时触发</li>
</ul>
</li>
<li>
<p>第二种收集信息的形式：非受控组件，允许用户获取到原生DOM，自己来操作数据</p>
<ul>
<li>使用非受控组件获取input中值
<ul>
<li>创建ref ： React.createRef()</li>
<li>把创建ref添加到标签上，使用ref属性 ref={this.mref}</li>
<li>获取DOM，this.myref.current</li>
</ul>
</li>
</ul>
</li>
...
<h2 id="状态提升" tabindex="-1"><a class="header-anchor" href="#状态提升" aria-hidden="true">#</a> 状态提升</h2>
<ol>
<li>数据的传递方向：
<ul>
<li>父级向子级传递，使用props</li>
<li>子级向父级传递，状态提升</li>
</ul>
</li>
<li>用法
<ol>
<li>让父级向子级传递一个函数 <code>&lt;Son user= getSonDate={this.getSonDate.bind(this)}/&gt;</code></li>
...
<ol>
<li>有些组件无法提前知晓它们子组件的具体内容。在Sidebar (侧边栏)和Dialog (对话框)等展现通用容器(box)的组件中特别容易遇到这种情况。我们建议这些组件使用一个特殊的childrenprop來将他们的子组件传递到渲染结果中</li>
<li>用法:</li>
