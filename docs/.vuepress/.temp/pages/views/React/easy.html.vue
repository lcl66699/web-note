<template><p>安个vs的小插件   安好输入rcc  可快捷创建类 rfc快速创建函数</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token number">1.</span> React介绍
...
<span class="token literal-property property">单页面应用的优缺点</span><span class="token operator">:</span>
...
create <span class="token operator">-</span>react<span class="token operator">-</span> app my<span class="token operator">-</span> appcreate <span class="token operator">-</span>react<span class="token operator">-</span> app my<span class="token operator">-</span> app
    ...
    npx的执行分<span class="token number">3</span><span class="token literal-property property">步，第一步</span><span class="token operator">:</span>下载脚手架，第二步<span class="token operator">:</span> 使用脚手架安装项目。第三步<span class="token operator">:</span>下载好项目后删除脚手架。
...
<span class="token number">4.</span> jsx语法
    <span class="token number">1.</span> <span class="token operator">-</span> 在js中可以直接写html
        <span class="token operator">-</span> <span class="token constant">HTML</span><span class="token literal-property property">部分</span><span class="token operator">:</span>直接写html标签
        <span class="token operator">-</span> <span class="token constant">JS</span><span class="token literal-property property">部分</span><span class="token operator">:</span>写在<span class="token punctuation">{</span><span class="token punctuation">}</span>内
    ...
    说明：<span class="token number">1.</span> js的事件，驼峰命名法
          <span class="token number">2.</span> EventFunction<span class="token operator">:</span>对应的事件功能，编写的形式
                ...
                <span class="token keyword">class</span> <span class="token class-name">App</span> <span class="token keyword">extends</span> <span class="token class-name">React<span class="token punctuation">.</span>Component</span><span class="token punctuation">{</span>
                        ...
                        <span class="token punctuation">}</span>
                    <span class="token punctuation">}</span>
    ##    <span class="token number">3</span><span class="token punctuation">.</span>this指向问题
...
<span class="token literal-property property">target</span><span class="token operator">:</span><span class="token string">'https://3g.163.com//touch/reconstruct/article/list'</span><span class="token punctuation">,</span>
<span class="token literal-property property">changeOrigin</span><span class="token operator">:</span><span class="token boolean">true</span><span class="token punctuation">,</span>
<span class="token literal-property property">pathRewrite</span><span class="token operator">:</span><span class="token punctuation">{</span>
<span class="token string-property property">'/inex'</span><span class="token operator">:</span><span class="token string">''</span>
<span class="token punctuation">}</span>
<span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">)</span>
<span class="token punctuation">}</span>
...
<span class="token number">3.</span> 配置
    ...
    <span class="token number">3.</span> Route的特点<span class="token operator">:</span>贪婪匹配
        不想贪婪，想一次加载一个路由，实现方式<span class="token number">2</span><span class="token literal-property property">种</span><span class="token operator">:</span>
...
<span class="token literal-property property">pathpame</span><span class="token operator">:</span> <span class="token operator">/</span>detail<span class="token operator">/</span>$<span class="token punctuation">{</span>id<span class="token punctuation">}</span> <span class="token operator">|</span>
<span class="token punctuation">}</span><span class="token punctuation">}</span><span class="token operator">></span>
遍历
    ...
    <span class="token number">8.</span> 路由重定向
        ...
        <span class="token number">2.</span> 用法
            ...
            <span class="token number">2.</span> 直接作为标签使用
                <span class="token operator">&lt;</span>Redirect from<span class="token operator">=</span><span class="token string">'/c'</span> to<span class="token operator">=</span><span class="token string">'/'</span><span class="token operator">/</span><span class="token operator">></span>
    ...
    <span class="token number">3.</span> 用法：
         错误边界也是一个组件，定义好后包裹其他的组件，这个组件必须是<span class="token keyword">class</span>定义的，同时这个组件中必须有以下两个生命周期函数中的至少一个
             <span class="token keyword">static</span> <span class="token function">getDerivedStateFromError</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">{</span>
       		 <span class="token keyword">return</span> <span class="token punctuation">{</span><span class="token literal-property property">iserror</span><span class="token operator">:</span><span class="token boolean">true</span><span class="token punctuation">}</span>
   				 <span class="token punctuation">}</span>
...
<span class="token number">3.</span> redux
    ...
    <span class="token number">3.</span> 三大原则
        ...
        <span class="token number">3</span><span class="token punctuation">.</span>State 是只读的
...
Connect里面是两个函数可定义
      <span class="token number">1.</span> 把store的存储的数据放到组件的props上
         <span class="token keyword">function</span> <span class="token function">mapStateToProps</span><span class="token punctuation">(</span><span class="token parameter">state</span><span class="token punctuation">)</span><span class="token punctuation">{</span>
     		...
     		<span class="token keyword">return</span> <span class="token punctuation">{</span><span class="token literal-property property">user</span><span class="token operator">:</span>state<span class="token punctuation">}</span>
<span class="token punctuation">}</span>
